...
public class State {
    ...
    public State(List<Statements> statements, Variables globalVariables, Variables localVariables, Result pastResult, Return returnVal, int currentLine, boolean isGlobal) {
